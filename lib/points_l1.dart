...
import 'package:number_guess/points_l2.dart';
import 'dart:math';
...
class Points extends StatefulWidget {
  ...
  @override
  State<Points> createState() => _NumPointsState();
}

class _NumPointsState extends State<Points> {
                ...
                onPressed: () {
                  ...
                  if (userip == rndmno) {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => Points_l2(points: points),
                      ),
                    );
                  } else if (points == 0) {
                    Navigator.push(
